...
HTML that has meaning for browsers to interpret

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Inline elements only use as much space as they need and don't start a new line, usually.
...
Version control and allowing multiple developers to work on a project simultaneously.
